...
<script type="text/javascript">
	...
	function onchange_display(a, value,value_text,datas,value_blod_name) {
		...
		var v = a.value;
		if ("text" == v) {
			html = "<td align=\"right\">文本值：</td><td ><input name=\"value\" value=\""+value+"\" type=\"text\"/></td>";
		} else if ("textarea" == v) {
			html = "<td align=\"right\">大文本值：</td><td ><textarea name=\"value_text\">"+value_text+"</textarea></td>";
		} else if ("select" == v) {
		    ...
		    if(value!=''&&datas!=''){
			sel = "<td align=\"right\">数据源值：</td><td ><select name=\"value\" id='seldatas_id'><dic:loadSelectTag tableName='tb_dictionary' key='id' text='value' id='"+value+"_id' where=' and pid="+datas+" ' /></select></td>";
		    }else{
		    	sel = "<td align=\"right\">数据源值：</td><td ><select name=\"value\" id='seldatas_id'></select></td>";
		    }
		} else if ("radio" == v) {
			html = "<td align=\"right\">数据源：</td><td ><select  name=\"datas\" onchange=\"_systemUI.loadSelect(this,'seldatas_id','tb_dictionary','id','value',' and pid=','');\"  ><dic:loadSelectTag tableName='tb_dictionary' key='id' text='value' id='"+datas+"_id' where=' and pid=0 '/></select></td>";
			  if(value!=''&&datas!=''){
			...
			html = "<td align=\"right\">附件：</td><td ><input name=\"value_blod\" type=\"file\"/>"+value_blod_name+"</td>";
		}
...
<option value=\"file\">附件上传</option>\
		...
		var html = "<form action=\"savefield\" method=\"post\"   enctype=\"multipart/form-data\"  id=\"form1\">"
				...
				+ ft
				+ "</td></tr>"
				+ "<tr id='content_show_id'><td align=\"right\">值：</td><td><input name=\"value\" type=\"text\"/></td></tr><tr  id='content_value_id'  ></tr>"
	...
	function editField(id,proid,retype,fieldtype,fieldname,fieldvalue,sort,datas,value,value_text,value_blod_name) {
		...
		if ("text" == fieldtype) {
			...
			inp_value = "<td align=\"right\">文本值：</td><td ><input name=\"value\" value=\""+value+"\" type=\"text\"/></td>";
		} else if ("textarea" ==fieldtype) {
		 textarea = "<option value=\"textarea\" selected=\"selected\">大文本</option>";
		 inp_value = "<td align=\"right\">大文本值：</td><td ><textarea name=\"value_text\">"+value_text+"</textarea></td>";
		    ...
		    if(value!=''&&datas!=''){
			inp_sel = "<td align=\"right\">数据源值：</td><td ><select name=\"value\" id='seldatas_id'><dic:loadSelectTag tableName='tb_dictionary' key='id' text='value' id='"+value+"_id' where=' and pid="+datas+" ' /></select></td>";
		    }else{
		    	inp_sel = "<td align=\"right\">数据源值：</td><td ><select name=\"value\" id='seldatas_id'></select></td>";
		    }
			...
			inp_value = "<td align=\"right\">附件：</td><td ><input name=\"value_blod\" type=\"file\"/>"+value_blod_name+"</td>";
