...
<div class="am-cf admin-main" style="margin-left: 5px;">
  ...
  <div class="admin-content">
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">走进亦蓁</strong> / <small>Personal information</small></div>
    </div>
    ...
    <div class="am-g">
      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">																			
        <form class="am-form am-form-horizontal" action="saveMessage" method="post" id="form" enctype="multipart/form-data">
        	<input name="id" type="hidden" value="${data.id }"/>
          <div class="am-form-group">
            <label for="user-name" class="am-u-sm-3 am-form-label">类型</label>
            <div class="am-u-sm-9">
              <input type="text"  value="${data.type }" name="type"  >
                            <span>类型 1 重要通知  2 消息 3 一般通知</span>																			    
              
            </div>	
          </div>
      
      	<div class="am-form-group">
            <label for="user-name" class="am-u-sm-3 am-form-label">用户</label>
            <div class="am-u-sm-9">
              <select name="uid">
                <option value="">全部</option>
              <c:forEach items="${datauser }" var="item">
                <option value="${item.id }" <c:if test="${item.id==data.uid }"> selected="selected"</c:if> >${item.uname }</option>
             ...
             <div class="am-form-group">
            <label for="user-phone" class="am-u-sm-3 am-form-label">内容</label>
            <div class="am-u-sm-9">
