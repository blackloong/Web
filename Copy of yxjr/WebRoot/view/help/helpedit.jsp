...
<div class="am-cf admin-main" style="margin-left: 5px;">
  ...
  <div class="admin-content">
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">帮助中心</strong> / <small>Personal information</small></div>
    </div>
    ...
    <div class="am-g">
      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">																			
        <form class="am-form am-form-horizontal" action="helpEditSub" method="post" id="form" enctype="multipart/form-data">
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <textarea class="article_tip" id="myEditor" name="content" style="width: 790px; height: 252px;" name="content">${data.content }</textarea> 
            </div>
          </div>
         ...
         <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              ...
              <span>1 app常见问题   2  邀请好友分享模板  3 短信模板  4 注册协议  5 审核流程  6公告</span>
            </div>	
