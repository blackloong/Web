...
<script type="text/javascript" >
	...
	function addDetail (id){
		var html = "<form action=\"typedicEditSub\" method=\"post\" id=\"form2\"><input name='id' value='' type='hidden'/><input name='pid' value='"+id+"' type='hidden'/>"+
		...
		"<tr><td align=\"right\" >类型：</td><td ><input name=\"type\" type=\"text\" /><td></tr>"+
			"<tr><td align=\"right\" >拼音缩写：</td><td ><input name=\"py\" type=\"text\"/><td></tr>"+
				...
				"<tr><td align=\"right\" >说明：</td><td ><textarea class=\"article_tip\" id=\"myEditor\" name=\"instruction\" style=\"width:400px; height: 175px;\" ></textarea><td></tr>"+
					              ...
					              <td>\
					                <div class="am-btn-toolbar">\
					                  <div class="am-btn-group am-btn-group-xs">\
										<a  class="am-btn am-btn-default am-btn-xs am-text-secondary" style="background-color: #fff;" href="javascript:editDetail(\''+item.id+'\',\''+item.value+'\',\''+item.type+'\',\''+item.py+'\',\''+item.orderby+'\',\''+item.instruction+'\')"><span class="am-icon-pencil-square-o"></span>编辑</a>\
					                  </div>\
					                </div>\
					              </td>\
					            </tr>';
   ...
   // 子分类编辑 <a  class="am-btn am-btn-default am-btn-xs am-text-secondary" style="background-color: #fff;" href="javascript:showDetail(\''+item.id+'\',\''+item.value+'\')"><span class="am-icon-pencil-square-o"></span>维护子分类数据</a>\
	
	function editDetail (id,value,type,py,orderby,instruction){
		var html = "<form action=\"typedicEditSub\" method=\"post\" id=\"form2\"><input name='id' value='"+id+"' type='hidden'/>"+
		"<table align=\"center\" style=\"margin-top:30px;\" >"+
		...
		"<tr><td align=\"right\" >类型：</td><td ><input name=\"type\" type=\"text\" value='"+type+"'/><td></tr>"+
			"<tr><td align=\"right\" >拼音缩写：</td><td ><input name=\"py\" type=\"text\" value='"+py+"'/><td></tr>"+
				...
				"<tr><td align=\"right\" >说明：</td><td ><textarea class=\"article_tip\" id=\"myEditor\" name=\"instruction\" style=\"width: 400px; height:175px;\" >"+instruction+"</textarea><td></tr>"+
	...
	function showDetail (itemid,itemname){
		layer.open({
			title:itemname+"_子分类级维护",
			type:2,
			area: ['80%', '75%'],
			content:"typedicshow?id="+itemid
		});
