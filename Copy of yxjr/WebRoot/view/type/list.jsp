        ...
        <div class="am-fl am-cf">
          <div class="am-btn-toolbar am-fl">
            <div class="am-btn-group am-btn-group-xs">
              <a type="button" class="am-btn am-btn-default" href="typedicedit"><span class="am-icon-plus"></span> 新增</a>
          ...
          <c:forEach items="${pageData }" var="item">
              ...
              <td>
                <div class="am-btn-toolbar">
                  <div class="am-btn-group am-btn-group-xs">
					<a  class="am-btn am-btn-default am-btn-xs am-text-secondary" style="background-color: #fff;" href="typedicedit?id=${item.id }"><span class="am-icon-pencil-square-o"></span>编辑</a>
					<a  class="am-btn am-btn-default am-btn-xs am-text-secondary" style="background-color: #fff;" href="javascript:showDetail(${item.id },'${item.value }')"><span class="am-icon-pencil-square-o"></span>维护二级数据</a>
                  </div>
                </div>
              </td>
            </tr>
