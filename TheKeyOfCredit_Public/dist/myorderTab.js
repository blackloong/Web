...
/******/ 	var hotCurrentHash = "1d6b000d20afc1e1c63c"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PositionList = __webpack_require__(172);
	var MyorderPage = __webpack_require__(187);
	var NetConstants = __webpack_require__(171);

	var tabNames = ['正在等待', '已经完成'];

	var userCreditCapitalHis = NetConstants.userCreditCapitalHis;
	var urls = [userCreditCapitalHis, userCreditCapitalHis];
	...
	var PositionTest = React.createClass({
	    ...
	    componentWillUnmount: function componentWillUnmount() {
	        //isOwnStockPage={true} 添加动支编号输入框
	    },
	    render: function render() {
	        var tabPages = [React.createElement(MyorderPage, { dataURL: urls[0], ref: 'page1', isOwnStockPage: true }), React.createElement(MyorderPage, { dataURL: urls[1], ref: 'page2' })];
	        var elements = [];
	        var tabs = tabNames.map(function (tabName, i) {
	            return elements.push(tabPages[i]);
	        });
	        return React.createElement(PositionList, { sliders: elements, ref: 'Slider1', sliderIndex: this.state.currentSelectedTab, callback: this.slideCallback, isHorizontal: this.props.isHorizontal, slideType: "drawer" });
	    }
	});

	React.render(React.createElement(PositionTest, { isPager: false, isHorizontal: true }), document.getElementById("tab-content"));

	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(168); if (makeExportsHot(module, __webpack_require__(65))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "myorder.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Base = {
	     ...
	     * 正则
	     */
	    isTest: function isTest(value, regStr) {
	     ...
	     * key
	     */
	    loadUrl: function loadUrl(url, key, params) {
	    ...
	    fetchTHUrl: function fetchTHUrl(url, params, successCallback, errorCallback) {
	    ...
	    selectImage: function selectImage(file, callback) {
	    ...
	    uploadImage: function uploadImage(url, param, file, callback, params) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	//const SERVER_IP = 'http://120.55.161.84:8064'
	Object.defineProperty(exports, '__esModule', {
	  value: true
	});
	var SERVER_IP = 'http://121.40.185.130:8072';
	var getGoodsByIndustry = SERVER_IP + '/api/CreditKey/getGoodsByIndustry';
	exports.getGoodsByIndustry = getGoodsByIndustry;
	var getMerchantByID = SERVER_IP + '/api/CreditKey/getMerchantByID';

	exports.getMerchantByID = getMerchantByID;
	//export const userCreditCapitalHis = SERVER_IP + '/api/CreditKey/userCreditCapitalHis'
	var userCreditCapitalHis = SERVER_IP + '/api/CreditKey/UserCreditCapitalDetailHis';

	exports.userCreditCapitalHis = userCreditCapitalHis;
	var GetBackBillLists = SERVER_IP + '/api/CreditKey/GetBackBillLists';
	exports.GetBackBillLists = GetBackBillLists;
	var SearchCapitalBind = SERVER_IP + '/api/CreditKey/SearchCapitalBind';
	exports.SearchCapitalBind = SearchCapitalBind;
	var costRepaymentPlan = SERVER_IP + '/api/CreditKey/costRepaymentPlan';
	exports.costRepaymentPlan = costRepaymentPlan;
	var sign = SERVER_IP + '/api/CreditKey/sign';
	exports.sign = sign;
	var AddCusSearch = SERVER_IP + '/api/CusSearch/AddCusSearch';
	exports.AddCusSearch = AddCusSearch;
	var GoodsImg = SERVER_IP + '/GoodsImg/';
	exports.GoodsImg = GoodsImg;

	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(168); if (makeExportsHot(module, __webpack_require__(65))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "NetConstants.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PositionItem = __webpack_require__(173);
	//var Tip = require("Tip");
	var wWidth = 0;
	var wHeight = 0;
	var sliderIndex = 0;
	var PositionList = React.createClass({
	    ...
	    propTypes: {
	        ...
	        sliderIndex: React.PropTypes.number },
	    //当前页
	    ...
	    componentDidUpdate: function componentDidUpdate() {
	        if (this.state.isTouchend) {
	            if (!this.state.isSuccess) {} else {
	                ...
	                $(".yo-Htab #li" + sliderIndex).addClass('item-on');
	    ...
	    getShowprops: function getShowprops(sliderIndex, isNext) {
	     ...
	     * 页面滑动
	     */
	    setPageTranslate: function setPageTranslate() {
	        /**
	         * 获取滑动距离
	     ...
	     */
	    translateSuccess: function translateSuccess() {
	     ...
	     * @param touchDelate   滑动距离
	     */
	    translateFail: function translateFail() {
	        this.onTranslateEnd(false);
	    },
	    /**
	     * 滑动结束
	     */
	    onTranslateEnd: function onTranslateEnd(isSuccess) {
	        this.state.isTouchend = true;
	    ...
	    render: function render() {
	        ...
	        var SliderItems = this.props.sliders.map(function (sliderValue, index) {
	            ...
	            return React.createElement(PositionItem, { key: index, element: sliderValue,
	                zIndex: zIndex,
	                isShow: isShow,
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                "div",
	                _extends({ className: "slider-inner" }, Events),
	                SliderItems
	            )
	        );
	    }
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(168); if (makeExportsHot(module, __webpack_require__(65))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "PositionList.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PositionItem = React.createClass({
	    ...
	    render: function render() {
	        ...
	        var styleElement = {};
	        styleElement["transform"] = translate;
	        ...
	        if (this.props.slideShadow != "") {
	            styleElement["boxShadow"] = this.props.slideShadow;
	        }

	        return React.createElement(
	            "div",
	            { className: "slider-item " + (this.props.isShow ? "" : "hide "),
	                style: styleElement },
	            this.props.element
	        );
	    }
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(168); if (makeExportsHot(module, __webpack_require__(65))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "PositionItem.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LogicData = {
	    ...
	    setWechatAuthData: function setWechatAuthData(authData) {
	        wechatAuthData = authData;
	    },

	    getWechatAuthData: function getWechatAuthData() {
	        return wechatAuthData;
	    },

	    setWechatUserData: function setWechatUserData(userData) {
	        wechatUserData = userData;
	    },

	    getWechatUserData: function getWechatUserData() {
	        return wechatUserData;
	    },

	    loadOwnStocksData: function loadOwnStocksData() {
	    ...
	    setOwnStocksData: function setOwnStocksData(stocksData) {
	        ownStocksData = stocksData;
	        localStorage.setItem(OWN_STOCKS_DATA_STORAGE_KEY, "'" + JSON.stringify(ownStocksData));
	    },

	    getOwnStocksData: function getOwnStocksData() {
	        return ownStocksData;
	    },

	    addStockToOwn: function addStockToOwn(stockData) {
	        var findResult = ownStocksData.find(function (stock) {
	    ...
	    removeStockFromOwn: function removeStockFromOwn(stockData) {
	        var index = ownStocksData.findIndex(function (stock) {
	            return stock.id === stockData.id;
	        });
	        if (index != -1) {
	    ...
	    addMyGoods: function addMyGoods(GoodsData) {
	        localStorage.setItem(MyGoods_KEY, "'" + JSON.stringify(GoodsData));
	    },
	    loadMyGoodsData: function loadMyGoodsData() {
	        var Goods = localStorage.getItem(MyGoods_KEY);
	        console.log(JSON.parse(Goods.substr(1, Goods.length)));
	        return JSON.parse(Goods.substr(1, Goods.length));
	    }
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(168); if (makeExportsHot(module, __webpack_require__(65))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "LogicData.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(65);
	var LogicData = __webpack_require__(175);
	var NetConstants = __webpack_require__(171);

	var Tip = __webpack_require__(188);
	var Base = __webpack_require__(167);
	var iscard = true;
	// var testdata={
	//   "Code":"00",
	//   "Message":"成功！",
	//   "Data":[{
	//       "creditApplyCode":"201602151320",
	//       "creditState":2,
	//       "consumeState":3,
	//       "CreditAmount":100000,
	//       "surplusAmount":15000,
	//       "CumConsumption":85000,
	//       "effectiveStartTime":"2015-06-28",
	//       "effectiveEndTime":"2015-09-28",
	//       "CaptialHistoryList":[{
	//           "capitalApplyCode":"20150703001",
	//           "applyTime":"2015-07-03",
	//           "use":"旅游贷-日本7日游",
	//           "auditAmount":15000,
	//           "dual":12,
	//           "capitalState":5,
	//           "MerchantName":"商户a",
	//           "MerchantPhone":"13555555555",
	//           "GoodsName":"商品a",
	//           "GoodsImgName":"null",
	//           "Extended8":"1580.00*6",
	//           "DongZhiMoney":2000
	...
	//     ]
	// };
	var MyorderPage = React.createClass({
	    displayName: "MyorderPage",

	    propTypes: {
	        loadingTitle: React.PropTypes.string, //加载标题
	        dataURL: React.PropTypes.string,
	        sceneName: React.PropTypes.string, //数据url
	        ...
	        if (!this.props.isOwnStockPage) {
	            ...
	            $.ajax({
	                ...
	                success: (function (data) {
	                    ...
	                    console.log(data);
	                    var capitalState = data.Data[0].CaptialHistoryList[0].capitalState;
	                    if (capitalState >= 3) {
	                        this.setState({
	                            stockInfo: data.Data
	                        });
	            ...
	            console.log(this.props.isOwnStockPage);
	            //console.log( {'checkMsg':$.md5(Key),mobile:localStorage.getItem('Mobile')})
	            $.ajax({
	                url: this.props.dataURL,
	                data: { 'checkMsg': $.md5(Key), mobile: localStorage.getItem('Mobile') },
	                type: 'POST',
	                ...
	                success: (function (data) {
	                    ...
	                    if (capitalState < 3) {
	                        ...
	                        if (capitalState >= 2) {
	                            //   $.ajax({
	                            // url : NetConstants.SearchCapitalBind,
	                            // data : {'checkMsg':$.md5(Key),applyCode:data.Data[0].creditApplyCode},
	                            // type:'POST',
	                            // dataType : 'json',
	                            // async : false,
	                            // success : function(data) {
	                            ...
	                            // });
	                            $.ajax({
	                                url: NetConstants.costRepaymentPlan,
	                                data: { 'checkMsg': $.md5(Key), applyCode: data.Data[0].CaptialHistoryList[0].capitalApplyCode,
	    ...
	    addToMyGoods: function addToMyGoods(rowID) {
	        if (rowID !== null) {
	            console.log(rowID);
	            LogicData.addMyGoods(this.state.stockInfo[rowID]);
	            window.location.replace('detailslider.html');
	        }
	    },
	    onapplyCode: function onapplyCode(applyCode) {
	        var Key = "KoeIy12Ay~oEuN3" + new Date().Format("yyyyMMdd");
	        if (iscard) {
	            if ($("#checkboxFiveInput").prop('checked')) {
	                console.log({ 'checkMsg': $.md5(Key), 'applyCode': applyCode });
	                console.log(NetConstants.sign);
	                $.ajax({
	                    url: NetConstants.sign,
	                    type: "POST",
	                    data: { 'checkMsg': $.md5(Key), 'applyCode': applyCode },
	                    dataType: 'json',
	                    async: true,
	                    success: function success(data) {

	                        console.log(data);
	                        localStorage.setItem("applyCode", applyCode);
	                        $(".pop2").show();
	                        $(".fontsize14paddingtop").html(data.Message);
	                    },
	                    error: function error(XMLHttpRequest, textStatus, errorThrown) {}
	                });
	            } else {
	                ...
	                $.ajax({
	                    ...
	                    success: (function (data) {
	                        ...
	                        var content = data.date[0].content;
	                        content = content.replace('a001', this.state.rowStockInfoData.ContractNo);
	                        content = content.replace('a002', this.state.rowStockInfoData.CustomerName);
	                        content = content.replace('a003', this.state.rowStockInfoData.LoanUse);
	                        content = content.replace('a004', this.state.rowStockInfoData.MoveAmount);
	                        content = content.replace('a005', this.state.rowStockInfoData.YearRate);
	                        content = content.replace('a006', this.state.rowStockInfoData.RepaymentMethod);
	                        content = content.replace('a007', this.state.rowStockInfoData.Email);
	                        content = content.replace('a008', this.state.rowStockInfoData.ConsultFee);
	                        content = content.replace('a009', this.state.rowStockInfoData.Assessment);
	                        content = content.replace('a010', this.state.rowStockInfoData.Management);

	                        content = content.replace('a012', this.state.rowStockInfoData.LoanUserName);
	                        content = content.replace('a013', this.state.rowStockInfoData.LoanBankName);
	                        content = content.replace('a014', this.state.rowStockInfoData.LoanBankAccount);

	                        //content=content.replace('a015', this.state.rowStockInfoData.ContractNo);
	                        //content=content.replace('a016', this.state.rowStockInfoData.ContractNo);
	            ...
	            window.location.replace('bindCard.html');
	        }
	    },
	    ClickapplyCode: function ClickapplyCode() {
	        var Key = "KoeIy12Ay~oEuN3" + new Date().Format("yyyyMMdd");

	        $.ajax({
	            url: NetConstants.costRepaymentPlan,
	            type: "POST",
	            data: { 'checkMsg': $.md5(Key), 'applyCode': $(".inputapplyCode").val(), mobile: localStorage.getItem('Mobile') },
	            dataType: 'json',
	            async: true,
	            success: (function (data) {
	                console.log(data);
	                ...
	                if (data.Data != null) {
	                    ...
	                    localStorage.setItem("applyCode", data.ApplyCode);
	                } else {
	    ...
	    //            <div className="divspan"></div>
	    //                    <div className="item  Grid ">
	    //                     <div className="Grid-cell u-1of12 "><span className="fontsize013">没有数据</span> </div>
	    //                          </div>
	    //                     </div>  
	    //            </div>
	    //            </div>
	    ...
	    render: function render() {
	        ...
	        var inputapplyCode = null;
	        var inputapplyCode1 = null;
	        ...
	        if (this.state.stockInfo.length > 0) {
	            ...
	            newElements = this.state.stockInfo.map(function (rowData, index) {
	                ...
	                if (rowData.creditState === 1) {

	                    msg = '等待信用评估';
	                    button = React.createElement(
	                        "div",
	                        { className: "Grid-cell u-1of52 " },
	                        " ",
	                        React.createElement("input", { type: "button", value: "取消借款", className: "button1 yo-btn-h " }),
	                        " "
	                    );
	                    button1 = React.createElement(
	                        ...
	                        { className: "Grid-cell u-1of52 " },
	                        " ",
	                        React.createElement("input", { type: "button", value: "立即完成", className: "button2 yo-btn-h1 " }),
	                        " "
	                    );
	                    //popmsg1= '请联系商户取消借款';
	                    //popmsg2= (<a href={ "tel:"+ rowData.CaptialHistoryList[0].MerchantPhone} className="affirm yo-ico  yypf-ico"  >&#xE815; { rowData.CaptialHistoryList[0].MerchantName} </a>)
	                    pop2msg1 = '您的信用评估正在审核，';
	                    pop2msg2 = '请耐心等待';
	                } else if (rowData.creditState === 2) {

	                    switch (rowData.CaptialHistoryList[0].capitalState) {
	                        case 0:
	                            if (rowData.consumeState == 1 || rowData.consumeState == 2) {
	                                msg = '等待交易信息';
	                                button = React.createElement(
	                                    "div",
	                                    { className: "Grid-cell u-1of52 " },
	                                ...
	                                popmsg1 = '请联系商户取消借款';
	                                popmsg2 = React.createElement(
	                                    "a",
	                                    { href: "tel:" + rowData.CaptialHistoryList[0].MerchantPhone, className: "affirm yo-ico  yypf-ico" },
	                                    " ",
	                                    rowData.CaptialHistoryList[0].MerchantName,
	                                    " "
	                                );
	                                pop2msg1 = '正在等待商户上传您的交易信息';
	                                pop2msg2 = '请耐心等待';
	                            } else if (rowData.consumeState == 4) {
	                        ...
	                        case 1:
	                            ...
	                            button1 = React.createElement(
	                                ...
	                                { className: "Grid-cell u-1of52 " },
	                                " ",
	                                React.createElement("input", { type: "button", value: "立即完成", className: " yo-btn-h1", onClick: this.onapplyCode.bind(this, rowData.CaptialHistoryList[0].capitalApplyCode) }),
	                                " "
	                            );
	                            popmsg1 = '请联系商户取消借款';
	                            popmsg2 = React.createElement(
	                        ...
	                        case 2:
	                            msg = '等待放款';
	                            //button= (<div className="Grid-cell u-1of52 "> <input type="button" value="取消借款" className="button1 yo-btn-h"   /> </div> )
	                            button1 = React.createElement(
	                                "div",
	                                { className: "Grid-cell u-1of52 " },
	                                " ",
	                        ...
	                        case 3:
	                            ...
	                            button = React.createElement(
	                                ...
	                                React.createElement(
	                                    "a",
	                                    { href: "myhaikuan.html", className: " yo-btn-h" },
	                                    "立即还款"
	                                ),
	                                " "
	                            );
	                ...
	                var xieyi = rowData.CaptialHistoryList[0].capitalState === 1 ? React.createElement(
	                    "div",
	                    { className: "item" },
	                    React.createElement(
	                        "div",
	                        { className: "checkboxone" },
	                        React.createElement("input", { type: "checkbox", value: "1", id: "checkboxFiveInput", name: "chkItem" }),
	                        React.createElement("label", { htmlFor: "checkboxFiveInput" })
	                    ),
	                    React.createElement(
	                        "b",
	                        { className: "agreement " },
	                ...
	                return React.createElement(
	                    "div",
	                    { className: "yo-list" },
	                    React.createElement("div", { className: "divspan" }),
	                    React.createElement(
	                        "div",
	                        { className: "item  Grid " },
	                        React.createElement(
	                            "div",
	                            { className: "Grid-cell u-1of12 " },
	                            React.createElement(
	                                "span",
	                                { className: "fontsize013" },
	                                rowData.CaptialHistoryList[0].MerchantName
	                            ),
	                            " "
	                        ),
	                    ...
	                    React.createElement(
	                        "div",
	                        { className: "item4  Grid " },
	                        React.createElement(
	                            "div",
	                            { className: "mark1" },
	                            React.createElement("img", { src: rowData.CaptialHistoryList[0].GoodsImgName === null ? "" : NetConstants.GoodsImg + rowData.CaptialHistoryList[0].GoodsImgName })
	                        ),
	                        React.createElement(
	                            "div",
	                            { className: "flex yo-list" },
	                            React.createElement(
	                                "div",
	                                { className: "last col c1  Grid-cell u-1of11 " },
	                                React.createElement(
	                                    "p",
	                                    { className: "name fontsize018" },
	                                    rowData.CaptialHistoryList[0].use
	                                ),
	                                React.createElement(
	                                    "p",
	                                    { className: "symbol" },
	                                    "动支单号：",
	                                    rowData.CaptialHistoryList[0].capitalApplyCode
	                                )
	                            ),
	                            React.createElement(
	                                "p",
	                                ...
	                                React.createElement(
	                                    ...
	                                    null,
	                                    "￥",
	                                    rowData.CaptialHistoryList[0].DongZhiMoney
	                                ),
	                                "   ",
	                                React.createElement(
	                                    "b",
	                                    { className: "marginleft25" },
	                                    rowData.CaptialHistoryList[0].Extended8
	                                )
	                            ),
	                            xieyi
	                        ),
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            "div",
	                            { className: "Grid-cell u-1of2 " },
	                            React.createElement(
	                                "span",
	                                { className: "fontsize014" },
	                                " ",
	                                React.createElement(
	                                    "a",
	                                    { href: "tel:" + rowData.CaptialHistoryList[0].MerchantPhone, className: "affirm yo-ico  yypf-ico" },
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            "i",
	                            { className: " yo-ico  yypf-ico fontsize04" },
	                            " "
	                        )
	                    ),
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            "div",
	                            { className: "fontsize14paddingtop" },
	                            popmsg1
	                        ),
	                        React.createElement(
	                            "div",
	                            { className: "fontsize13paddingbottom" },
	                            popmsg2
	                        )
	                    ),
	                    React.createElement("input", { type: "button", value: "           取消           ", className: "yo-btn-h pophide" }),
	                    React.createElement(
	                        "a",
	                        { href: "index.html" },
	                        React.createElement("input", { type: "button", value: "           首页           ", className: "yo-btn-h1" }),
	                        "   "
	                    )
	                )
	            ),
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement("input", { type: "button", value: "           取消           ", className: "yo-btn-h pop2hide" }),
	                    React.createElement(
	                        "a",
	                        { href: "index.html" },
	                        React.createElement("input", { type: "button", value: "           首页           ", className: "yo-btn-h1" }),
	...
	//<div className="fontsize13paddingbottom">月供:198.01</div></p>
	module.exports = MyorderPage;

	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(168); if (makeExportsHot(module, __webpack_require__(65))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "MyorderPage.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tip = React.createClass({
	    ...
	    show: function show(transactionInfo) {
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            "div",
	            { className: "pop2", onClick: this.onClose },
	            React.createElement(
	                "div",
	                { className: "yo-tip" },
	                " ",
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(168); if (makeExportsHot(module, __webpack_require__(65))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "Tip.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)(module)))
