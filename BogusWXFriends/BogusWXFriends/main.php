...
<div style="margin:0 auto;display:none;">
    <img class="data-avt" src='http://wx.qlogo.cn/mmopen/1CHHx9Yq4nEiagw9boNvuAdbTh8Fb0zDwdVWyVu4l5zsGgDSpNyosXLD8icyib1Mdiaiaw0dtXBI1V8CBQmZDGoBomJzWVwpKicanT/0'>
</div>
<header id="header" style="display:none">
    <img id="bg" src="img/bg.jpg">
    <p id="user-name" class="data-name">celia</p>
    <img id="avt" class="data-avt" src='http://wx.qlogo.cn/mmopen/1CHHx9Yq4nEiagw9boNvuAdbTh8Fb0zDwdVWyVu4l5zsGgDSpNyosXLD8icyib1Mdiaiaw0dtXBI1V8CBQmZDGoBomJzWVwpKicanT/0'>
</header>
    ...
    <div id="list">
        ...
        <li>
            <div class="po-avt-wrap">
                <img class="po-avt data-avt" src='http://wx.qlogo.cn/mmopen/1CHHx9Yq4nEiagw9boNvuAdbTh8Fb0zDwdVWyVu4l5zsGgDSpNyosXLD8icyib1Mdiaiaw0dtXBI1V8CBQmZDGoBomJzWVwpKicanT/0'>
            </div>
            <div class="po-cmt">
                <div class="po-hd">
                    <p class="po-name">
            ...
            <div class="po-cmt">
                <div class="po-hd">
					...
					<div class="post">
                        ...
                        <img class="data-avt list-img" src='http://wx.qlogo.cn/mmopen/1CHHx9Yq4nEiagw9boNvuAdbTh8Fb0zDwdVWyVu4l5zsGgDSpNyosXLD8icyib1Mdiaiaw0dtXBI1V8CBQmZDGoBomJzWVwpKicanT/0'>
                    </div>
                    <p class="time">
                        2分钟前
                    </p>
...
<script>
	...
	nickname = 'celia';headimgurl ='http://wx.qlogo.cn/mmopen/1CHHx9Yq4nEiagw9boNvuAdbTh8Fb0zDwdVWyVu4l5zsGgDSpNyosXLD8icyib1Mdiaiaw0dtXBI1V8CBQmZDGoBomJzWVwpKicanT/0';uid ='ojPseweZ5--XgFxkgrxu_bg4TOl8';img ='http://wx.qlogo.cn/mmopen/1CHHx9Yq4nEiagw9boNvuAdbTh8Fb0zDwdVWyVu4l5zsGgDSpNyosXLD8icyib1Mdiaiaw0dtXBI1V8CBQmZDGoBomJzWVwpKicanT/0';
	$(function(){
